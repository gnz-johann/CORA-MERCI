...
## Corpus Check
- 64 files · ~56,628 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 285 nodes · 397 edges · 25 communities
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `41525004`
...
6. `RolesYPermisos()` - 6 edges
7. `MERCI — Frontend (contexto de proyecto para Claude Code)` - 6 edges
8. `scripts` - 5 edges
9. `AuditoriaView()` - 5 edges
10. `HistorialLlamadas()` - 5 edges
